...
login_id = "root"
login_pw = "..itiss"
capture_data_count = 400
log_dir = "/home/pi/python/GUI_training/04_PyTerm/log"
criteria = 0.25
...
def serial_login():
    ...
    ser.write(bytes("elite16v2_poweron", encoding='utf-8'))
...
if __name__ == "__main__":
    #Serial Access
    serial_login()
    result_a, result_b, result_x = serial_test()
